...
{
    public class JaroWinklerFilteringService : IFilteringService
    {
        public const string FilterAlgorithm = "JaroWinkler";

        public string Filter(string originalString, string[] filters, double threshold)
        {
            foreach (var filter in filters)
            {
                double similarity = JaroDistance(originalString, filter) * 100;
